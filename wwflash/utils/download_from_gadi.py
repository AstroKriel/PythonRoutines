...
BASEPATH_GADI            = "/scratch/jh2/nk7952"
...
# LIST_RES_FOLDERS             = [ "18", "36", "72" ]
# LIST_RES_FOLDERS             = [ "144", "288", "576" ]
    ...
    for sim_folder in LIST_SIM_FOLDER:
      ...
      if BOOL_GET_PLOTS_NRES or BOOL_GET_VIDEOS_NRES:
        ...
        for res_folder in LIST_RES_FOLDERS:
          ...
          filepath_mac_nres_vis  = f"{filepath_mac_sim}/{res_folder}/" # no need for extra subfolder
          filepath_gadi_nres_vis = f"{filepath_gadi_sim}/{res_folder}/vis_folder/"
          ## check that the filepath exists (MAC)
          if not os.path.exists(filepath_mac_nres_vis): continue
          print(f"Looking at Nres: {res_folder}...")
