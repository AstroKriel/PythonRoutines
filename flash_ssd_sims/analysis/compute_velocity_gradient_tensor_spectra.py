...
class ComputeVelocityGradientTensorSpectrum():
  def __init__(self, directory_sim, bool_recompute):
    self.spectra_name   = "velocity_gradient_tensor_spectra"
  ...
  def performRoutines(self):
    ...
    for plt_filename in self.list_plt_filenames:
      ...
      spectrum_1d = self._computeVelocityGradientTensorSpectrum(plt_filename, self.cmap_t_turb(self.norm_t_turb(t_turb)))
  ...
  def _computeVelocityGradientTensorSpectrum(self, plt_filename, color):
    ...
    r2tensor_nabla_u = derived_var_funcs.DerivedVars().gradient_tensor(vfield_u)
    print("Computing spectrum...")
    spectrum_3d = power_spectra_funcs.compute_tensor_power_spectrum(r2tensor_nabla_u)
    k_modes, spectrum_1d = power_spectra_funcs.spherical_integrate(spectrum_3d)
    del vfield_u, r2tensor_nabla_u, spectrum_3d
